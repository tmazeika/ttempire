...
/* WEBPACK VAR INJECTION */(function($) {window.$ = __webpack_require__(5);
__webpack_require__(6).start();

$('a[data-cart-link]').on('click', function () {
    var e = $(this);
    var set = $(this).attr('href').includes('/set');
